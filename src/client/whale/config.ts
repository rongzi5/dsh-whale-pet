...
export const TAIL_NOTCH = { x: 21.873, y: 5.441 }
export const DORSAL_BL = 10.436
export const DORSAL_BR = 13.852
export const PEC_BL = 16.747
export const PEC_BR = 20.614
export const PEC_DROP = 0.288
